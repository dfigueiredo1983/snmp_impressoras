...
def snmp_context():
    ...
    for printer in printer_list:
        if printer == '10.44.0.114':
            context[printer] = snmp_printer_color(printer)
        else:
            context[printer] = snmp_printer_bw(printer)
...
if __name__ == '__main__':
    ...
    for printer in printer_ip:
        if printer == '10.44.0.114':
            snmp_printer_color(printer)
        else:
            snmp_printer_bw(printer)
        print()
